  ...
  return (
    <div className="space-y-8">
      ...
      <div className="card-gray">
        <h2 className="font-sans text-xl font-bold mb-4">next schedule:</h2>
        {patients.length > 0 ? (
          <div className="flex gap-6 overflow-x-auto pb-2">
            {patients.slice(0, 4).map((p) => (
              <div key={p.BookingId} className="flex flex-col items-center gap-2 min-w-[120px]">
                ...
                <span className="font-sans text-base text-center">{p.Fullname || 'patient-name'}</span>
      ...
      {/* Patient's list */}
      <div>
        <h2 className="font-sans text-2xl font-bold mb-4">patient's list:</h2>
            ...
            patients.map((p) => (
              <div key={p.BookingId} className="card-yellow flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-sans text-base">{p.Fullname || 'patient-name'}</p>
      ...
      {/* Pagination */}
      {patients.length > 0 && (
        <div className="flex justify-center gap-3 font-sans text-lg italic text-gray-500">
